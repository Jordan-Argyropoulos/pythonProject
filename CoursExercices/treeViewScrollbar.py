...
class Tableau():
    ...
    def mod_rec(self):
        ...
        #  Ajouter mise a jour du fichier ...
        self.data[rec[0]] = rec # ... ecrit sur disque les données
        pass
...
if __name__ == '__main__':
    ...
    ta = Tableau(ws, header, fArticles)
    ws.mainloop()
    logger.info('Fin du programme')

    receptionStruct = ['id', 'date', 'article', 'qty']
    receptions = Rec('receptions.csv', receptionStruct)
    tr = Tableau(ws, receptionStruct, receptions)
    ws.mainloop()